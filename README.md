...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/txt2img
```

A live public deployment of this template is available at [https://txt2img.templates.workers.dev](https://txt2img.templates.workers.dev)
